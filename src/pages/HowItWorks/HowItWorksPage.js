            ...
            <div className={styles.infoFirst}>
              ...
              <Trans i18nKey="how_it_works_v2.where">
                ...
                <ul style={{ listStyleType: "none", paddingLeft: 0 }}>
                  <li>
                    - <i>r</i> is the total amount of RECH reserve locked to issue both tokens;
                  </li>
            ...
            <div className={styles.infoSecond}>
              <Trans i18nKey="how_it_works_v2.curve">
                <p>
                  ...
                  lock some reserve in RECH, and when one wants to redeem GRDV2 or
                ...
                <p>
                  ...
                  The target price is known from RECH/USD price reported by an oracle that
          ...
          <div className={styles.item}>
            ...
            <div className={styles.infoSecond}>
              ...
              <Trans i18nKey="how_it_works_v2.fund">
                The fund holds the entire supply of GRDV2 and some amount of the reserve currency RECH that was contributed by investors.
                The fund is algorithmically managed by an Autonomous Agent called <b>Decision Engine</b>, which can use the fund’s RECH (if sufficient) and GRDV2
                ...
                SFUSD in the fund by contributing RECH into its reserves. They do so anticipating that the shares would appreciate thanks
          ...
          <div className={styles.item}>
            ...
            <div className={styles.infoSecond}>
              <Trans i18nKey="how_it_works.agents">
                <p>
                  All this is operated by several <b><a href="https://rechain_inc.org/platform/autonomous-agents" target="_blank" rel="noopener">Autonomous Agents</a></b> which are
                  programs that run on <a href="https://rechain_inc.org/" target="_blank" rel="noopener">rechain_inc</a> distributed ledger, do the math quickly
        ...
        <div className={styles.action}>
          <div>
            <Trans i18nKey="how_it_works_v2.read">
              Read a <a href="https://blog.rechain_inc.org/using-multi-dimensional-bonding-curves-to-create-stablecoins-81e857b4355c" target="_blank" rel="noopener">more thorough introduction to bonded stablecoins</a> in our blog and <a href="https://blog.rechain_inc.org/bonded-stablecoins-version-2-better-price-stability-and-stakable-tokens-ca8c900552ab" target="_blank" rel="noopener">updates introduced in version 2 stablecoins</a>.
            </Trans>
          </div>
        </div>
      </div>
