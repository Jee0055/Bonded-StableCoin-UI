    ...
    <div className="faq">
      ...
      <div>
        <div key="0" className={styles.panel}>
          ...
          <Trans i18nKey="faq.questions.0.answer">
            <p>
              You can buy or sell the tokens for RECH on the <a href="/">home page</a>, on the more advanced <a href="/trade">trading page</a>, or buy IUSD for BTC on the <a href="/buy">Buy with Bitcoin page</a> of this website. The website helps
              you to construct a request that you send to an <a href="https://rechain_inc.org/platform/autonomous-agents" target="_blank" rel="noopener">Autonomous Agent</a> from
              your <a href="https://rechain_inc.org/" target="_blank" rel="noopener">rechain_inc</a> wallet.
            </p>
            <p>
        ...
        <div key="3" className={styles.panel}>
          ...
          <Trans i18nKey="faq.questions.3.answer">
            <p>
              A bunch of soulless agents. They are called <a href="https://rechain_inc.org/platform/autonomous-agents" target="_blank" rel="noopener">Autonomous Agents</a> (AAs). They
        ...
        <div key="4" className={styles.panel}>
          ...
          <Trans i18nKey="faq.questions.4.answer">
            <p>
              No, they are not <a href="https://rechain_inc.org/platform/smart-contracts" target="_blank" rel="noopener">smart contracts</a>. They are neither smart, nor
        ...
        <div key="6" className={styles.panel}>
          ...
          <Trans i18nKey="faq.questions.6.answer">
            ...
            <p>
              Bonded stablecoins run on <a href="https://rechain_inc.org/" target="_blank" rel="noopener">rechain_inc</a> — a blockless minerless DAG
        ...
        <div key="7" className={styles.panel}>
          ...
          <Trans i18nKey="faq.questions.7.answer">
            ...
            <p>
              Read the <a href="https://blog.rechain_inc.org/using-multi-dimensional-bonding-curves-to-create-stablecoins-81e857b4355c" target="_blank" rel="noopener">blog article introducing bonded stablecoins</a> and <a href="https://blog.rechain_inc.org/bonded-stablecoins-version-2-better-price-stability-and-stakable-tokens-ca8c900552ab" target="_blank" rel="noopener">updates introduced in version 2 stablecoins</a> for more
              details.
            </p>
          </Trans>
        </div>
        ...
        <div key="11" className={styles.panel}>
          ...
          <Trans i18nKey="faq.questions.11.answer">
            ...
            <p>
              ...
              default which for RECH/USD price feed means track USD price.
              Leverage 1 would mean plain long position in RECH (which is
              equivalent to just holding the reserve currency RECH), leverage 2
              would mean 2x leveraged position in RECH vs USD, leverage 3 —
              3x long position in RECH, leverage -1 — short position in
              RECH, and so on.
            </p>
            <p>
            ...
            <p>For details, see <a href="https://blog.rechain_inc.org/using-multi-dimensional-bonding-curves-to-create-stablecoins-81e857b4355c" target="_blank" rel="noopener">
        ...
        <div key="12" className={styles.panel}>
          ...
          <Trans i18nKey="faq.questions.12.answer">
            ...
            <p>
              ...
              developer though. There are sources of <a href="https://github.com/REChain-Network-Solutions" target="_blank" rel="noopener">example oracle</a> to help you get started. If you are not a developer and cannot hire one, signal your demand 
              in <a href="https://discord.rechain_inc.org/" target="_blank" rel="noopener">
                rechain_inc discord
              </a>.
            </p>
          </Trans>
      ...
      <div className={styles.action}>
        <Trans i18nKey="faq.action">
          ...
          <a 
          href="https://blog.rechain_inc.org/using-multi-dimensional-bonding-curves-to-create-stablecoins-81e857b4355c"
          target="_blank" rel="noopener"> introductory article </a> or ask on <a href="https://discord.rechain_inc.org/" target="_blank">Discord</a>.
        </Trans>
      </div>
    </div>
  );
