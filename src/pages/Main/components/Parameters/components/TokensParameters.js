    ...
    <div style={{ marginBottom: 20 }}>
        ...
        <span>
          ...
          <a
            href={`https://${config.TESTNET ? "testnet" : ""
              }explorer.rechain_inc.org/asset/${symbol1 || asset1}`}
            target="_blank"
            rel="noopener"
          >
            {asset1}
      ...
      <div className={styles.param}>
        ...
        <span>
          ...
          <a
            href={`https://${config.TESTNET ? "testnet" : ""
              }explorer.rechain_inc.org/asset/${symbol2 || asset2}`}
            target="_blank"
            rel="noopener"
          >
            {asset2}
      ...
      <div className={styles.param}>
        ...
        <span>
          ...
          <a
            href={`https://${config.TESTNET ? "testnet" : ""
              }explorer.rechain_inc.org/asset/${symbol3 || asset}`}
            target="_blank"
            rel="noopener"
          >
            {asset}
      ...
      {shares_asset && <div className={styles.param}>
        ...
        <span>
          ...
          <a
            href={`https://${config.TESTNET ? "testnet" : ""
              }explorer.rechain_inc.org/asset/${symbol4 || shares_asset}`}
            target="_blank"
            rel="noopener"
          >
            {shares_asset}
