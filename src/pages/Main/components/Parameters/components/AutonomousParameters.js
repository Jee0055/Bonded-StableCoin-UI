    ...
    <div style={{ marginBottom: 20 }}>
        ...
        <span>
          <a
            href={`https://${config.TESTNET ? "testnet" : ""
              }explorer.rechain_inc.org/address/${curve_aa}`}
            target="_blank"
            rel="noopener"
          >
            {curve_aa}
      ...
      {deposit_aa && <div className={styles.param}>
        ...
        <span>
          <a
            href={`https://${config.TESTNET ? "testnet" : ""
              }explorer.rechain_inc.org/address/${deposit_aa}`}
            target="_blank"
            rel="noopener"
          >
            {deposit_aa}
      ...
      {stable_aa && <div className={styles.param}>
        ...
        <span>
          <a
            href={`https://${config.TESTNET ? "testnet" : ""
              }explorer.rechain_inc.org/address/${stable_aa}`}
            target="_blank"
            rel="noopener"
          >
            {stable_aa}
      ...
      {fund_aa && <div className={styles.param}>
        ...
        <span>
          <a
            href={`https://${config.TESTNET ? "testnet" : ""
              }explorer.rechain_inc.org/address/${fund_aa}`}
            target="_blank"
            rel="noopener"
          >
            {fund_aa}
      ...
      {governance_aa && <div className={styles.param}>
        ...
        <span>
          <a
            href={`https://${config.TESTNET ? "testnet" : ""
              }explorer.rechain_inc.org/address/${governance_aa}`}
            target="_blank"
            rel="noopener"
          >
            {governance_aa}
      ...
      {decision_engine_aa && <div className={styles.param}>
        ...
        <span>
          <a
            href={`https://${config.TESTNET ? "testnet" : ""
              }explorer.rechain_inc.org/address/${decision_engine_aa}`}
            target="_blank"
            rel="noopener"
          >
            {decision_engine_aa}
