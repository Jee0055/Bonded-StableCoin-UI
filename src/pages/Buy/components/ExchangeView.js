          ...
          <Text type="secondary">
            <Trans i18nKey="buy.currently_converting" currency_from={currency_from}>
              Currently converting <span style={{ textTransform: "uppercase" }}>
                {{currency_from}}
              </span> to RECH, this step is performed by {{providerName: provider === "oswapcc" ? "oswap.cc" : "simpleswap.io"}}. For support issues, please contact them on their <a href={statusPageUrl} target="_blank" rel="noopener">support page</a>.
            </Trans>
          </Text>
        </div>
      </Row>)}
