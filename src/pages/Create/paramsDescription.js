...
export const paramsDescription = () => ({
  ...
  reserve_asset: {
    ...
    desc: i18n.t("params.reserve_asset.desc", "Asset used as reserve to back the issuance of Token1 and Token2. RECH is the default."),
  },
  interest_rate: {
  ...
  oracle2: {
    ...
    desc: i18n.t("params.oracle2.desc", "Optional second oracle. Use it if you want to multiply or divide prices of different assets. E.g. to create a stablecoin pegged to TSLA, you need to divide two price feeds: RECH/USD and TSLA/USD.")
  },
  feed_name2: {
