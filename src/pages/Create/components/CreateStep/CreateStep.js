...
export const CreateStep = ({ data, setCurrent, type }) => {
  ...
  return (
    <Result
      ...
      subTitle={t("create.sending_request.subTitle", "Please click the «Create» button below, this will open your rechain_inc wallet and you'll send a transaction that will create the new stablecoin.")}
      extra={[
        <QRButton
          href={link}
          type="primary"
