            ...
            <p>
              <Text type="secondary">
                <Trans i18nKey="modals.add_wallet.desc">
                  Insert your rechain_inc wallet address. If you don't have rechain_inc wallet yet,{" "}
                  <a href="https://rechain_inc.org/#download" target="_blank" rel="noopener">install</a> it.
                </Trans>
              </Text>
            </p>
          }>
